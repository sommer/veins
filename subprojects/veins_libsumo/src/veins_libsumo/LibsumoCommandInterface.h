...
public:
    LibsumoCommandInterface(cComponent* owner, LibsumoConnection& c, bool ignoreGuiCommands);
    ...
    public:
        Road(LibsumoCommandInterface* traci, std::string roadId)
            : traci(traci)
            , roadId(roadId)
        {
            connection = &traci->connection;
    ...
    public:
        Lane(LibsumoCommandInterface* traci, std::string laneId)
            : traci(traci)
            , laneId(laneId)
        {
            connection = &traci->connection;
    ...
    public:
        Trafficlight(LibsumoCommandInterface* traci, std::string trafficLightId)
            : traci(traci)
    ...
    public:
        LaneAreaDetector(LibsumoCommandInterface* traci, std::string laneAreaDetectorId)
            : traci(traci)
    ...
    public:
        Polygon(LibsumoCommandInterface* traci, std::string polyId)
            : traci(traci)
            , polyId(polyId)
        {
            connection = &traci->connection;
    ...
    class VEINS_API Poi {
    public:
        Poi(LibsumoCommandInterface* traci, std::string poiId)
            : traci(traci)
            , poiId(poiId)
        {
            connection = &traci->connection;
    ...
    public:
        Junction(LibsumoCommandInterface* traci, std::string junctionId)
            : traci(traci)
    ...
    public:
        Route(LibsumoCommandInterface* traci, std::string routeId)
            : traci(traci)
            , routeId(routeId)
        {
            connection = &traci->connection;
    ...
    public:
        GuiView(LibsumoCommandInterface* traci, std::string viewId)
