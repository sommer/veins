...
#include "veins_libsumo/TraCITestApp.h"

#include "veins_libsumo/utils/asserts.h"
    ...
    if (testNumber == testCounter++) {
        ...
        if (t == 30) {
            ...
            if (r) {
                ...
                const LibsumoMobility* traci2 = FindModule<LibsumoMobility*>::findSubModule(const_cast<cModule*>(mod));
