...
void LibsumoMobility::Statistics::initialize()
{
...
void LibsumoMobility::Statistics::watch(cSimpleModule&)
{
}

void LibsumoMobility::Statistics::recordScalars(cSimpleModule& module)
{
...
void LibsumoMobility::initialize(int stage)
{
    if (stage == 0) {
...
void LibsumoMobility::handleSelfMsg(cMessage* msg)
{
...
void LibsumoMobility::nextPosition(const Coord& position, std::string road_id, double speed, Heading heading, VehicleSignalSet signals)
{
...
void LibsumoMobility::changePosition()
{
...
void LibsumoMobility::changeParkingState(bool newState)
{
    Enter_Method_Silent();
    isParking = newState;
...
double LibsumoMobility::calculateCO2emission(double v, double a) const
{
...
Coord LibsumoMobility::calculateHostPosition(const Coord& vehiclePos) const
{
    Coord corPos;
