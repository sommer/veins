...
sending layer. \saf{MacToPhyCtrlInfo interface}\\

The \underline{control channel} is used by the \h{\bp} to inform the \h{\bm}
about
certain events\req{defprovactive}, like the TX\_OVER\req{deftxover} message 
...
The reference provides a passive way\req{defprovpassive} for the  \h{\bm} to 
get
