...
#ifndef TEST_BASE_MOBILITY_H
#define TEST_BASE_MOBILITY_H
 ...
 *
 * TestBaseMobility provides random placement of hosts and display
 * updates.
 * Change notifications about position changes are also posted to the
 * Blackboard.
 *
 * Another service provided by TestBaseMobility is border handling. If a
 * host wants to move outside the playground, this situation has to be
 * handled somehow. TestBaseMobility provides handling for the 4 most
 ...
 * @author Daniel Willkomm, Andras Varga
 */
class TestBaseMobility : public BaseModule
{
  public:
    /**
  ...
  public:
    Module_Class_Members( TestBaseMobility , BaseModule , 0 );
  ...
  protected:
	...
	error("TestBaseMobility does not move the host");
    };
