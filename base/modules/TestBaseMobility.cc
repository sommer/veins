...
Define_Module(TestBaseMobility);
...
void TestBaseMobility::initialize(int stage)
{
    ...
    if (stage == 0){
        ...
        coreEV << "initializing TestBaseMobility stage " << stage << endl;
 ...
 */
void TestBaseMobility::handleMessage(cMessage * msg)
{
 ...
 */
void TestBaseMobility::handleSelfMsg(cMessage * msg)
{
    makeMove();
    updatePosition();
 ...
 * playground.
 **/
void TestBaseMobility::handleBorderMsg(cMessage * msg)
{
 ...
 * changes!
 */
void TestBaseMobility::updatePosition() {
...
/**
 * Helper function for TestBaseMobility::reflectIfOutside().
 *
 * Reflects a given coordinate according to the given
 * BorderHandling.
 *
 */
void TestBaseMobility::reflectCoordinate(BorderHandling border, Coord& c)
{
    switch( border ){
    case X_SMALLER:
        c.setX(-c.getX());
 ...
 **/
void TestBaseMobility::reflectIfOutside(BorderHandling wo, Coord& stepTarget, Coord& targetPos, Coord& step, double& angle) {
 ...
 * @param targetPos target position of the host (for non atomic movements)
 **/
void TestBaseMobility::wrapIfOutside(BorderHandling wo, Coord& stepTarget, Coord& targetPos) {
    switch( wo ){
    case X_SMALLER:
    case X_BIGGER:
 ...
 **/
void TestBaseMobility::placeRandomlyIfOutside( Coord& targetPos )
{
 ...
 * TODO fix for 3D
 **/
TestBaseMobility::BorderHandling TestBaseMobility::checkIfOutside( Coord targetPos, Coord& borderStep )
{
 ...
 * TODO fix for 3D
 **/
void TestBaseMobility::goToBorder(BorderPolicy policy, BorderHandling wo, Coord& borderStep, Coord& borderStart)
{
    double factor;
 ...
 * TODO fix for 3D
 **/
bool TestBaseMobility::handleIfOutside(BorderPolicy policy, Coord& stepTarget, Coord& targetPos, Coord& step, double& angle) {
