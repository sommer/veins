...
protected:
	...
	//TODO: Check for a better constant version of the iterator than just
	//		copying it.
	
	/**
	 * Iterator for which iterates over every intersection of
	 * a specific interval in a AirFrameMatrix.
	 */
	class IntersectionIterator {
	public:
		AirFrameMatrix* intervals;
		simtime_t from;
		simtime_t to;
		AirFrameMatrix::iterator endIt;
		AirFrameTimeList::iterator startIt;
		bool alreadyNext;
	...
	/**
	 * The const variant of the intersection iterator.
	 */
	class ConstIntersectionIterator {
	public:
		const AirFrameMatrix* intervals;
		simtime_t from;
		simtime_t to;
		AirFrameMatrix::const_iterator endIt;
		AirFrameTimeList::const_iterator startIt;
		bool alreadyNext;
