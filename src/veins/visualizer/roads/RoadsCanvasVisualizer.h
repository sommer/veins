 ...
 *
 */
class VEINS_API RoadsCanvasVisualizer : public cSimpleModule {
public:
...
protected:
    ...
    cPolylineFigure* createLine(const std::list<veins::Coord>& coords, cFigure::Color color, double width, bool zoom);
};
