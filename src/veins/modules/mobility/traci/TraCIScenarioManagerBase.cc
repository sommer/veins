...
TraCIScenarioManagerBase::TypeMapping TraCIScenarioManagerBase::parseMappings(std::string parameter, std::string parameterName, bool allowEmpty) {
...
bool TraCIScenarioManagerBase::isInRegionOfInterest(const TraCICoord& position, std::string road_id, double speed, double angle) {
