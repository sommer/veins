...
bool SNRThresholdDeciderOld::checkIfAboveThreshold(Mapping* map, simtime_t start, simtime_t end)
{
	assert(map);
...
simtime_t SNRThresholdDeciderOld::processSignalEnd(AirFrame* frame)
{
