#ifndef SNRTHRESHOLDDECIDERNEW_H_
#define SNRTHRESHOLDDECIDERNEW_H_
 ...
 * @ingroup decider
 */
class SNRThresholdDeciderNew : public BaseDecider
{
protected:
...
public:
	 ...
	 */
	SNRThresholdDeciderNew(DeciderToPhyInterface* phy,
				double snrThreshold,
				double sensitivity,
				double busyThreshold,
				int myIndex = -1,
	...
	virtual ~SNRThresholdDeciderNew() {};
...
#endif /* SNRTHRESHOLDDECIDERNEW_H_ */
