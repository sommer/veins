/***************************************************************************
 * file:        TestConstSpeedMobility.cc
 *
...
#include "TestConstSpeedMobility.h"

#include <FWMath.h>


Define_Module(TestConstSpeedMobility);
 ...
 */
void TestConstSpeedMobility::initialize(int stage)
{
  ...
  if ( world->use2D() ) {
    stepSize = Coord(0.0, 0.0);
  } else {
    stepSize = Coord(0.0, 0.0, 0.0);
  }
 ...
 */
void TestConstSpeedMobility::setTargetPosition()
{
 ...
 */
void TestConstSpeedMobility::makeMove()
{
...
/*
void TestConstSpeedMobility::fixIfHostGetsOutside()
{
    double dummy;
